    ...
    <section class="user-card-section">
        ...
        <div class="user-card-body">
            ...
            <div class="user-meta-grid">
                ...
                <p><strong>Location:</strong> <?php echo !empty($user['address']) ? htmlspecialchars($user['address']) : 'Not Set'; ?></p>
    ...
    <section class="info-widgets-grid">
        <div class="widget-card">
            ...
            <form
                ...
                method="POST">
                <input type="hidden" name="redirect_page" value="worker">
            ...
            <form
                ...
                <input
                    ...
                    accept="image/*"
                    required>
                <button type="submit" class="btn-save2">
                    Upload Photo
                </button>
            </form>
        </div>
